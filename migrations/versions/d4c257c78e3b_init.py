...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['id_usuario_creacion'], ['usuarios.id'], ),
    sa.ForeignKeyConstraint(['id_usuario_edicion'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('compras_proveedor',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.Column('id_usuario_edicion', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['id_proveedor'], ['proveedores.id'], ),
    sa.ForeignKeyConstraint(['id_tipo'], ['tipo_productos.id'], ),
    sa.ForeignKeyConstraint(['id_usuario_creacion'], ['usuarios.id'], ),
    sa.ForeignKeyConstraint(['id_usuario_edicion'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('fecha_creacion', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['id_compra'], ['compras_proveedor.id'], ),
